...
$.extend(Page.prototype, {
  ...
  /*
   * @description ??? SyantaxHighlighter
   ...
   * @param {String} SHTheme SyntaxHighLighter ??
   */
   ...
   * @description ??????
   * @param {Obj} obj ????????
   * @param {Obj} obj.SHTheme ???? SyntaxHighLighter ??
   */
...
*/
   ...
   * @description ????????
   * @param {String} id ?????? id
   * @param {String} commentFormHTML ????HTML
   * @param {String} endHTML ??????? table ?? div ??,??????
   */
   ...
   * @param {String} id ?????? id
   * @param {Int} top ??????????
   * @param {String} [parentTag] it ????? position ? relative ??? A ??,??? A ??
   */

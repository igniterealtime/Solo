<div class="footer">
    &copy; ${year} - <a href="${servePath}">${blogTitle}</a>${footerContent} Powered by <a href="http://b3log.org" target="_blank">B3log</a> • <a href="https://hacpai.com/tag/Solo" target="_blank">Solo</a> ${version}
